...
<template>
   ...
   rounded-lg dark:border-gray-700 mt-14">
         <!-- <div class="flex items-center justify-center h-48 mb-4 rounded bg-gray-50 dark:bg-gray-800"> -->
            <h1 class="text-gray-900 bg-gradient-to-r from-teal-200 to-lime-200 focus:outline-none focus:ring-lime-200 dark:focus:ring-teal-700 font-medium rounded-lg text-6xl h1x-5 py-5 text-center mr-2 mb-2">
